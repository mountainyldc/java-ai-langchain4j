...
public class RAGTest {
    ...
    public void testReadDocument() {
        Document document = FileSystemDocumentLoader.loadDocument("E:/java-ai-langchain4j/测试.txt");
        System.out.println(document.text());
        // 加载单个文档
        Document document2 = FileSystemDocumentLoader.loadDocument("E:/knowledge/file.txt", new TextDocumentParser());
        // 从一个目录中加载所有文档
        List<Document> documents1 = FileSystemDocumentLoader.loadDocuments("E:/knowledge", new TextDocumentParser());
        // 从一个目录中加载所有的.txt文档
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument(
                "E:/2026Langchain4j/课件/尚硅谷-Java+大模型应用-硅谷小智（医疗版）.pdf",
    ...
    public void testDocumentSplitter() {
        ...
        //自定义文档分割器
        //按段落分割文档：每个片段包含不超过 300个token，并且有30个token的重叠部分保证连贯性
